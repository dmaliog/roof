// calc/calc-rab/script.js
(function () {
    const encodedPassword = "0YPQtdCx0LjRidC1";
                            ...
                            filteredObjects.forEach((obj, index) => {
                                ...
                                if (obj.isExpense) {
                                    if (obj.name.toLowerCase() === 'бензин') {
                                        if (obj.receivers.length === 1 && obj.receivers.includes('Коля')) imageUrl = '/calc/calc-rab/img/nexia.png';
                                        else if (obj.receivers.length === 1 && obj.receivers.includes('Артём')) imageUrl = '/calc/calc-rab/img/ford.png';
                                        else imageUrl = '/calc/calc-rab/img/fuel.png';
                                    } else if (obj.name.toLowerCase() === 'съёмная квартира') {
                                        imageUrl = '/calc/calc-rab/img/house.png';
                                    } else if (obj.name.toLowerCase() === 'еда') {
                                        imageUrl = '/calc/calc-rab/img/eat.png';
                                    } else if (obj.name.toLowerCase() === 'займ') {
                                        imageUrl = '/calc/calc-rab/img/money.png';
                                    }
                                } else if (obj.isCustomService) {
                                    switch (obj.service) {
                                        case 'Электросварка перил и лестниц на кровле':
                                            imageUrl = '/calc/calc-rab/img/lestnica.png';
                                            break;
                                        case 'Погрузо-разгрузочные работы':
                                            imageUrl = '/calc/calc-rab/img/pogruzka.png';
                                            break;
                                        case 'Уборка территории':
                                            imageUrl = '/calc/calc-rab/img/cleaning.png';
                                            break;
                                    }
                                } else {
